...
<head>
    ...
    <link href="{{asset('frontend/css/m1.css')}}" rel="stylesheet">
...
<header id="header">
    ...
    <div class="header-middle">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">  
                    <a href="{{URL::to('/trang-chu')}}"><img src="{{URL::to('/frontend/images/haha.png')}}" width="250px" height="100px"></img></a>
                </div>
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            ?>
                                <li><a href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs fa-2x"></i> Thanh toán</a></li>
                            <?php
                            }else if($customer_id!=NULL && $shipping_id!=NULL){
                            ?>
                                <li><a href="{{URL::to('/payment')}}"><i class="fa fa-crosshairs fa-2x"></i> Thanh toán</a></li>
                            <?php }else{
                            ?>
                                 <li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-crosshairs fa-2x"></i> Thanh toán</a></li>
                            <?php
                            }
                            ?>
                                <li><a href="{{URL::to('/show-cart')}}"><i class="fa fa-shopping-cart fa-2x"></i> Giỏ hàng</a></li>
                            <?php

                            $customer_id = Session::get('customer_id');
                            if($customer_id){
                            ?>
                                <li><a href="{{URL::to('/logout-checkout')}}"><i class="fa fa-lock fa-2x"></i> Đăng xuất</a></li>
                            <?php
                            }
                            else{
                            ?>
                                <li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-lock fa-2x"></i> Đăng nhập</a></li>
                            <?php
                            }
                            ?>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                        <img src="{{URL::to('/frontend/images/banner1.jpg')}}" class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                        <img src="{{URL::to('/frontend/images/banner2.jpg')}}"  class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-12">
                                         <img src="{{URL::to('/frontend/images/banner3.jpg')}}" class="girl img-responsive" alt="" />
                    ...
                    <div class="panel-group category-products" id="accordian">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="hvr-shutter-out-horizontal" href="{{URL::to('/danh-muc-san-pham/'.$cate->category_id)}}">{{$cate->category_name}}</a></h4>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget subscribe no-box">
                            <h5 class="widget-title">HỖ TRỢ KHÁCH HÀNG<span></span></h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            <h5 class="widget-title">Xem nhanh<span></span></h5>
                            <ul class="thumbnail-widget">
                                <li>
                                    <div class="thumb-content"><a href="{{URL::to('/trang-chu')}}">Home</a></div>
                                </li>
                                <li>
                                    <div class="thumb-content"><a href="{{URL::to('/show-cart')}}">Giỏ hàng</a></div>
                                </li>
                                <li>
                                    <div class="thumb-content"><a href="{{URL::to('/checkout')}}">Thanh toán</a></div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            <h5 class="widget-title">Thành viên<span></span></h5>
                            <p>Nếu bạn chưa có tài khoản hãy click vào đây.</p>
                            <a class="btna" href="{{URL::to('/login-checkout')}}" target="_blank">Đăng ký ngay</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div class="widget no-box">
                            ...
                            <p><a href="mailto:ngockha4123@gmail.com" title="glorythemes">ngockha4123@gmail.com</a></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p>© 2020 Bản quyền của Công Ty Cổ Phần BanLapTop.</p>
                    </div>
                </div>
            </div>
        </div>
