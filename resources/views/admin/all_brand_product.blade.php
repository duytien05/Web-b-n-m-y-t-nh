                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                            <?php
                                ...
                                ?>
                                <a href="{{URL::to('/unactive-brand-product/'.$brand_pro->brand_id)}}"><span class="fa-check-styling fa fa-check-square"></span></a>
                            <?php
                                }else{
                                ?>
                                <a href="{{URL::to('/active-brand-product/'.$brand_pro->brand_id)}}"><span class="fa-check-styling fa fa-square-o"></span></a>
                            <?php
                                }
                                ?>
                        </span></td>
